...
public class NPC_BigRock extends Entity {
    ...
    public void setDialogue() {
        dialogues[0][0] = "It's just a giant rock.";
    }
    ...
    public void detectPlate() {
        ...
        for(int i = 0; i < gp.iTiles[1].length; i++) {
            if(gp.iTiles[gp.currentMap][i] != null && gp.iTiles[gp.currentMap][i].name != null && gp.iTiles[gp.currentMap][i].name.equals(IT_MetalPlate.itName)) {
