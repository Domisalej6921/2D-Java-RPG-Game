...
public class UI {
    ...
    public void drawDialogueScreen() {
        ...
        //Check if text is in dialogue array
        ...
        else { //if no text is found in array
            npc.dialogueIndex = 0;
    ...
    public void options_control(int frameX, int frameY) {
        ...
        g2.drawString("Character Info Screen:", textX, textY); textY += gp.tileSize;
        g2.drawString("Pause Game:", textX, textY); textY += gp.tileSize;
    ...
    public void trade_buy() {
        ...
        if(itemIndex < npc.inventory.size()) {
            ...
            String text = "" + price;
            x = getXforCenteredText(text) + gp.tileSize*8-20;
    ...
    public void trade_sell() {
        ...
        if(itemIndex < gp.player.inventory.size()) {
            ...
            String text = "" + price;
            x = getXforCenteredText(text) + gp.tileSize*18-20;
            g2.drawString(text, x, y+34);
